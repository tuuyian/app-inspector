...
class Differ
{
     ...
     */
    public function __construct($header = "<h4>Difference between two files:</h4><br><p class = 'lead'>--- Original<br>+++ New", $showNonDiffLines = true)
    {
        $this->header           = $header;
    ...
    private function getDiffBufferElement(array $diff, $buffer, $diffIndex)
    {
        if ($diff[$diffIndex][1] === 1 /* ADDED */) {
            $buffer .= "<p class = 'lead' style='margin:0;display:inline'>+</p>" . $diff[$diffIndex][0] . "\n";
